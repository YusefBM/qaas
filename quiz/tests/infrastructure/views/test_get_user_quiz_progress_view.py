...
class TestGetUserQuizProgressView(unittest.TestCase):
    ...
    def test_get_success_completed_quiz(self):
        ...
        self.assertEqual(response.data["my_participation"]["status"], "completed")
        self.assertEqual(response.data["my_participation"]["invited_at"], "2024-01-15T10:30:00.000000Z")
        self.assertEqual(response.data["my_participation"]["completed_at"], "2024-01-16T14:20:00.000000Z")
        self.assertEqual(response.data["my_participation"]["my_score"], 85)
        self.assertEqual(response.data["my_participation"]["score_percentage"], 85.0)
    ...
    def test_get_success_invited_quiz(self):
        ...
        self.assertEqual(response.data["my_participation"]["status"], "invited")
        self.assertEqual(response.data["my_participation"]["completed_at"], None)
        self.assertEqual(response.data["my_participation"]["my_score"], None)
        self.assertEqual(response.data["my_participation"]["score_percentage"], None)
    ...
    def test_get_success_perfect_score(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["my_participation"]["my_score"], 100)
        self.assertEqual(response.data["my_participation"]["score_percentage"], 100.0)
    ...
    def test_get_success_low_score(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["my_participation"]["my_score"], 25)
        self.assertEqual(response.data["my_participation"]["score_percentage"], 25.0)
    ...
    def test_get_with_decimal_score_percentage(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["my_participation"]["score_percentage"], 83.33)
    ...
    def test_get_with_large_quiz(self):
        ...
        self.assertEqual(response.data["my_participation"]["my_score"], 450)
